/**
 @brief Implementation to [count number of set bits of a number] (https://www.geeksforgeeks.org/count-set-bits-in-an-integer/) in an integer.
 @details We are given an integer number. We need to calculate the number of set bits in it. A binary number consists of two digits. They are 0 & 1. Digit 1 is known as set bit in computer terms.
...
namespace bit_manipulation { namespace count_of_set_bits {
  /**
...
}}  // namespace bit_manipulation::count_of_set_bits
