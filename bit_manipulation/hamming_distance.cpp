/**
 ...
 @details To find hamming distance between two integers, we take their xor, which will have a set bit iff those bits differ in the two numbers. Hence, we return the number of such set bits.
 */

#include <cassert>   /// for assert
#include <iostream>  /// for io operations

namespace bit_manipulation { namespace hamming_distance {
  /**
...
}}  // namespace bit_manipulation::hamming_distance
