/**
 * @file
 * @brief C++ program for maximum contiguous circular sum problem using [Kadane's
 ...
 * from the total sum. For more information, check [Geeks For
 * Geeks](https://www.geeksforgeeks.org/maximum-contiguous-circular-sum/) explanation page.
 */
