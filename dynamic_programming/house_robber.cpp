...
static void test() {
  ...
  std::cout << "Test 1... ";
  assert(dynamic_programming::house_robber::houseRobber(array1, array1.size()) ==
  ...
  std::cout << "Test 2... ";
  assert(dynamic_programming::house_robber::houseRobber(array2, array2.size()) ==
  ...
  std::cout << "Test 3... ";
  assert(dynamic_programming::house_robber::houseRobber(array3, array3.size()) ==
  ...
  std::cout << "Test 4... ";
  assert(dynamic_programming::house_robber::houseRobber(array4, array4.size()) ==
