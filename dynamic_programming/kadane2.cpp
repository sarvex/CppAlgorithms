...
int maxSubArray(const std::array<int, N> &n) {
  int curr_sum = 0;       // declaring a variable named as curr_sum and initialized it to 0
...
int main() {
  ...
  int max_sum = dynamic_programming::kadane::maxSubArray<N>(n);  // calling maxSubArray function
