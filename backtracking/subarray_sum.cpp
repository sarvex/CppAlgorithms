...
namespace backtracking { namespace subarray_sum {
  /**
...
}}  // namespace backtracking::subarray_sum
...
assert(backtracking::subarray_sum::subarray_sum(0, array1) ==
