/**
 ...
 @details We are given an array and a sum value. The algorithm finds all the subsets of that array with sum equal to the given sum and return such subsets count. This approach will have exponential time complexity.
 */
...
namespace backtracking { namespace subset_sum {
  /**
...
}}  // namespace backtracking::subset_sum
...
assert(backtracking::subset_sum::number_of_subsets(0, array1) == 2);  // first argument in subset_sum function is the
                                                                      // required sum and second is the input array
