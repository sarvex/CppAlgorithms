/**
 * @brief [N queens](https://en.wikipedia.org/wiki/Eight_queens_puzzle) all optimized
 */

#include <array>
#include <iostream>

namespace backtracking { namespace n_queens_optimized {
  /**
...
}}  // namespace backtracking::n_queens_optimized
