/**
 * @brief [Eight Queens](https://en.wikipedia.org/wiki/Eight_queens_puzzle) puzzle
...
namespace backtracking { namespace n_queens {
  /**
...
}}  // namespace backtracking::n_queens
...
int main() {
const int n = 4;
std::array<std::array<int, n>, n> board = {std::array<int, n>({0, 0, 0, 0}), std::array<int, n>({0, 0, 0, 0}),
