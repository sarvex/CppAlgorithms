...
static void test() {
  ...
  assert(hashing::md5::sig2hex(sig).compare("d41d8cd98f00b204e9800998ecf8427e") == 0);
  ...
  // Test with cassert whether sig is correct from the expected value
  assert(hashing::md5::sig2hex(sig2).compare("9e107d9d372bb6826bd81d3542a419d6") == 0);
  ...
  // Test with cassert whether sig is correct from the expected value
  assert(hashing::md5::sig2hex(sig3).compare("e4d909c290d0fb1ca068ffaddf22cbd0") == 0);
  ...
  // Test with cassert whether sig is correct from the expected value
  assert(hashing::md5::sig2hex(sig4).compare("d174ab98d277d9f5a5611c2c9f419d9f") == 0);
}
