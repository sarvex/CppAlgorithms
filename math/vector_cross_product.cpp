 ...
 * @file
 *
 * @brief Calculates the [Cross Product](https://en.wikipedia.org/wiki/Cross_product) and the magnitude of two
...
namespace math {
  ...
  namespace vector_cross {
    /**
     * @brief Function to calculate the cross product of the passed arrays containing the direction ratios of the two
