/**
 * @brief Program to calculate [Binomial coefficients](https://en.wikipedia.org/wiki/Binomial_coefficient)
 */
...
std::cout << "[+] Binomial coefficients calculate test completed" << std::endl;
}
