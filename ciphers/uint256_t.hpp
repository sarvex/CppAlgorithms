...
class uint256_t {
   ...
   */
  explicit uint256_t(const std::string &str) { __get_integer_from_string(str); }
  ...
  uint256_t operator*(const uint256_t &p) {
    ...
    uint128_t fi = f_first * s_first, se = f_first * s_second, th = s_first * f_second, fo = s_second * f_second;
   ...
   */
  inline bool operator<(const uint256_t &other) { return f < other.f || (f == other.f && s < other.s); }
   ...
   */
  inline bool operator==(const uint256_t &other) { return f == other.f && s == other.s; }
   ...
   */
  inline bool operator!=(const uint256_t &other) { return !((*this) == other); }
   ...
   */
  inline bool operator&&(const uint256_t &b) { return (s || f) && (b.s || b.f); }
   ...
   * @returns value of this & p (& is bit-wise operator)
   */
  inline uint256_t operator&(const uint256_t &p) { return {f & p.f, s & p.s}; }
   ...
   */
  inline uint256_t operator|(const uint256_t &p) { return {this->f | p.f, this->s | p.s}; }
