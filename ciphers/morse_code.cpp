/**
 @brief Implementation of [Morse Code] (https://en.wikipedia.org/wiki/Morse_code).
 @details Morse code is a method used in telecommunication to encode text characters as standardized sequences of two different signal durations, called dots and dashes or dits and dahs. Morse code is named after Samuel Morse, an inventor of the telegraph.
 */
#include <cassert>
#include <iostream>
#include <string>
...
namespace ciphers { namespace morse {
  /**
