...
namespace others {
  ...
  namespace iterative_tree_traversals {
   ...
   public:
      ...
      std::vector<int64_t> preOrderIterative(Node *);   ///< function that takes root of the tree as an argument, and
                                                        ///< returns its preorder traversal.
      std::vector<int64_t> postOrderIterative(Node *);  ///< function that takes root of the tree as an argument, and
                                                        ///< returns its postorder traversal.
      std::vector<int64_t> inOrderIterative(Node *);    ///< function that takes root of the tree as an argument, and
...
int main() {
  ...
  */
  ...
  others::iterative_tree_traversals::BinaryTree binaryTree;  ///< instace of BinaryTree, used to access its members
                                                             ///< functions.
