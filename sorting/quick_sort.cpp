...
static void tests() {
  ...
  std::vector<double> arr_sorted3 =
    sorting::quick_sort::quick_sort(arr3, 0, int(std::end(arr3) - std::begin(arr3)) - 1);
  ...
  std::cout << std::endl;
  std::cout << "3rd array:\n";
  sorting::quick_sort::show(arr_sorted3, int(std::end(arr3) - std::begin(arr3)) - 1);
  std::cout << std::endl;
