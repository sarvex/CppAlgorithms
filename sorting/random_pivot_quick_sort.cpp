...
namespace sorting {
  ...
  namespace random_pivot_quick_sort {
    ...
    std::tuple<int64_t, std::array<int64_t, size>> partition(std::array<int64_t, size> arr, int64_t start,
                                                             int64_t end) {
...
int main(int argc, char *argv[]) {
  ...
  std::array<int64_t, inputSize> sorted_array =
    sorting::random_pivot_quick_sort::quickSortRP(unsorted_array, 0, unsorted_array.size() - 1);
